...
const sample7 = new Tone.Player(`assets/hat_1.wav`).toDestination();
const sample8 = new Tone.Player(`assets/hat_2.wav`).toDestination();
const sample9 = new Tone.Player(`assets/tom_1.wav`).toDestination();
...
const sample13 = new Tone.Player(`assets/siren_1.wav`).toDestination();
const sample14 = new Tone.Player(`assets/scratch_1.wav`).toDestination();
